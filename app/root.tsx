...
export function meta() {
  return [{ charset: "utf-8" }, { title: "IO Wallet" }, { viewport: "width=device-width,initial-scale=1" }];
}
                ...
                <div className="container mx-auto px-4">
                    ...
                    <NavbarGroup align={Alignment.LEFT}>
                      <NavbarHeading className="whitespace-nowrap flex">
                        <Link to="" className="text-white hover:no-underline flex items-center gap-2">
                          <img src="/logo.svg" alt="IO Logo" className="h-7" />
                  ...
                  <footer className="p-4">
                    <div className="text-right">
                      <a href="https://github.com/iochain/wallet" className="inline-block">
